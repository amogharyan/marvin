...
A GitHub Copilot agent for gathering detailed requirements through targeted questions and analysis.

## Purpose

Conducts comprehensive requirements research by asking targeted questions, analyzing visual assets, and understanding product context. Transforms initial feature ideas into detailed, actionable requirements documentation.

## When to Use

- Converting initial feature ideas into detailed requirements
- Clarifying ambiguous or incomplete feature descriptions
- Gathering missing technical and business requirements
- Understanding feature integration with existing product architecture

## Research Capabilities

### Requirements Gathering
- **Targeted Questioning**: Generates specific questions to clarify feature scope
- **Visual Analysis**: Requests and analyzes design assets and mockups
- **Context Research**: Understands how features fit within product roadmap
- **Reusability Assessment**: Identifies opportunities to leverage existing code

### Product Context Analysis
- **Mission Alignment**: Ensures features support product vision and goals
- **Roadmap Integration**: Understands feature dependencies and priorities
- **Architecture Compatibility**: Checks integration with existing systems
- **Standards Compliance**: Ensures requirements align with agent-os standards

### Documentation Process
- **Iterative Refinement**: Uses follow-up questions to deepen understanding
- **Comprehensive Capture**: Documents all functional and non-functional requirements
- **Stakeholder Input**: Incorporates feedback from multiple perspectives
- **Visual Integration**: Connects design assets with functional requirements

## Research Workflow

1. **Initial Analysis**: Read raw feature idea and product context
2. **Question Generation**: Create targeted questions covering all aspects
3. **Visual Asset Request**: Request relevant designs, mockups, or examples
4. **Answer Processing**: Analyze responses and visual materials
5. **Follow-up Investigation**: Ask clarifying questions based on analysis
6. **Requirements Documentation**: Create comprehensive requirements document

## Output Structure

Creates `agent-os/specs/[feature]/planning/requirements.md` containing:
- Business objectives and user value
- Functional requirements with acceptance criteria
- Technical constraints and integration points
- Visual design requirements and asset references
- Performance and quality requirements

## Project-Specific Focus

### AR Morning Assistant Context
- Snap Spectacles integration requirements and constraints
- Object detection accuracy and performance needs
- AI processing requirements (Gemini, voice synthesis)
- Demo environment specifications and reliability targets
- User experience flows for AR interactions

## Example Usage

```
@spec-shaper Research detailed requirements for the AR object detection feature, focusing on the 5 demo objects and integration with Gemini AI for contextual responses.
```
